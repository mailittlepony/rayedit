...
`;var L=typeof Float32Array<"u"?Float32Array:Array;function h(){var n=new L(3);return L!=Float32Array&&(n[0]=0,n[1]=0,n[2]=0),n}function M(n){var e=n[0],t=n[1],s=n[2];return Math.sqrt(e*e+t*t+s*s)}function g(n,e,t){var s=new L(3);return s[0]=n,s[1]=e,s[2]=t,s}function D(n,e){return n[0]=e[0],n[1]=e[1],n[2]=e[2],n}function z(n,e,t){return n[0]=e[0]+t[0],n[1]=e[1]+t[1],n[2]=e[2]+t[2],n}function E(n,e,t){return n[0]=e[0]-t[0],n[1]=e[1]-t[1],n[2]=e[2]-t[2],n}function X(n,e,t){return n[0]=e[0]*t,n[1]=e[1]*t,n[2]=e[2]*t,n}function C(n,e,t,s){return n[0]=e[0]+t[0]*s,n[1]=e[1]+t[1]*s,n[2]=e[2]+t[2]*s,n}function b(n,e){var t=e[0],s=e[1],i=e[2],o=t*t+s*s+i*i;return o>0&&(o=1/Math.sqrt(o)),n[0]=e[0]*o,n[1]=e[1]*o,n[2]=e[2]*o,n}function y(n,e,t){var s=e[0],i=e[1],o=e[2],r=t[0],a=t[1],c=t[2];return n[0]=i*c-o*a,n[1]=o*r-s*c,n[2]=s*a-i*r,n}(function(){var n=h();return function(e,t,s,i,o,r){var a,c;for(t||(t=3),s||(s=0),i?c=Math.min(i*t+s,e.length):c=e.length,a=s;a<c;a+=t)n[0]=e[a],n[1]=e[a+1],n[2]=e[a+2],o(n,n,r),e[a]=n[0],e[a+1]=n[1],e[a+2]=n[2];return e}})();const l={SPHERE:0,CUBE:1,TORUS:2,CYLINDER:3,CONE:4,CAPSULE:5};let p=class B{static OBJECT_GPU_WPAD_SIZE_BYTES=80;name;_id;primitive;position;rotation;scale;color;_device;_objectBuffer;constructor(e){this.name=e.name??String(this.id),this.primitive=e.primitive??l.SPHERE,this.position=e.position??g(0,.5,0),this.rotation=e.rotation??g(0,0,0),this.scale=e.scale??g(.5,.5,.5),this.color=e.color??g(1,1,1)}get id(){return this._id}update(){const e=new Float32Array(B.OBJECT_GPU_WPAD_SIZE_BYTES/4);e.set([this._id,this.primitive],0),e.set(this.position??[0,0,0],4),e.set(this.rotation??[0,0,0],8),e.set(this.scale??[1,1,1],12),e.set(this.color??[1,1,1],16),this._device.queue.writeBuffer(this._objectBuffer,this._id*B.OBJECT_GPU_WPAD_SIZE_BYTES,e.buffer)}copy(){const e=new B({name:`${this.name}Copy`,primitive:this.primitive});return D(e.position,this.position),D(e.rotation,this.rotation),D(e.scale,this.scale),e}};class S{static GLOBALS_WPAD_SIZE_BYTES=96;device;context;format;bindGroup;vertexBuffer;globalsBuffer;objectsBuffer;activeObjectBuffer;activeObjectStagingBuffer;renderPipeline;lastGlobals={};objects=[];constructor(e){this.device=e.device,this.context=e.context,this.format=e.format,this.initPipelineAndBuffers()}getObjectCount(){return this.objects.length}initPipelineAndBuffers(){const{device:e}=this,t=new Float32Array([-1,-1,3,-1,-1,3]);this.vertexBuffer=e.createBuffer({size:t.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),e.queue.writeBuffer(this.vertexBuffer,0,t);const s=[{arrayStride:8,attributes:[{shaderLocation:0,offset:0,format:"float32x2"}],stepMode:"vertex"}];this.globalsBuffer=e.createBuffer({size:S.GLOBALS_WPAD_SIZE_BYTES,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.objectsBuffer=e.createBuffer({size:p.OBJECT_GPU_WPAD_SIZE_BYTES*1,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),this.activeObjectBuffer=e.createBuffer({size:4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),this.selectObject(null),this.activeObjectStagingBuffer=e.createBuffer({size:4,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST});const i=e.createShaderModule({code:W});this.renderPipeline=e.createRenderPipeline({vertex:{module:i,entryPoint:"vs_main",buffers:s},fragment:{module:i,entryPoint:"fs_main",targets:[{format:this.format}]},primitive:{topology:"triangle-list"},layout:"auto"}),this.bindGroup=e.createBindGroup({layout:this.renderPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.globalsBuffer}},{binding:1,resource:{buffer:this.objectsBuffer}},{binding:2,resource:{buffer:this.activeObjectBuffer}}]})}render(){const e=this.device.createCommandEncoder(),t={colorAttachments:[{loadOp:"clear",storeOp:"store",view:this.context.getCurrentTexture().createView()}]},s=e.beginRenderPass(t);s.setPipeline(this.renderPipeline),s.setVertexBuffer(0,this.vertexBuffer),s.setBindGroup(0,this.bindGroup),s.draw(3),s.end(),this.device.queue.submit([e.finish()])}addObject(e){const t=this.device;if(this.objects.length*p.OBJECT_GPU_WPAD_SIZE_BYTES>=this.objectsBuffer.size){const o=t.createBuffer({size:this.objectsBuffer.size*2,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),r=t.createCommandEncoder();r.copyBufferToBuffer(this.objectsBuffer,0,o,0,this.objectsBuffer.size),t.queue.submit([r.finish()]),this.objectsBuffer.destroy(),this.objectsBuffer=o;for(const a of this.objects)a._objectBuffer=this.objectsBuffer;this.bindGroup=t.createBindGroup({layout:this.renderPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.globalsBuffer}},{binding:1,resource:{buffer:this.objectsBuffer}},{binding:2,resource:{buffer:this.activeObjectBuffer}}]})}const s=this.objects.length;this.objects.push(e);const i=e;i._id=s,i._device=this.device,i._objectBuffer=this.objectsBuffer,e.update(),this.updateGlobals({objectCount:this.objects.length})}removeObject(e){if(e.id!=this.objects.length){const t=this.objects[this.objects.length-1];t._id=e.id,this.objects[e.id]=t;const s=this.device.createBuffer({size:p.OBJECT_GPU_WPAD_SIZE_BYTES,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),i=this.device.createCommandEncoder();i.copyBufferToBuffer(this.objectsBuffer,(this.objects.length-1)*p.OBJECT_GPU_WPAD_SIZE_BYTES,s,0,p.OBJECT_GPU_WPAD_SIZE_BYTES),i.copyBufferToBuffer(s,0,this.objectsBuffer,e.id*p.OBJECT_GPU_WPAD_SIZE_BYTES,p.OBJECT_GPU_WPAD_SIZE_BYTES),this.device.queue.submit([i.finish()])}this.objects.pop(),this.updateGlobals({objectCount:this.objects.length})}selectObject(e){this.device.queue.writeBuffer(this.activeObjectBuffer,0,new Float32Array([e?.id??-1]))}updateObjectOnGPU(e){const t=this.objects[e];if(!t)throw new Error("Object id does not exist");t.update()}updateGlobals(e){for(const s in e){const i=e[s];i!==void 0&&(this.lastGlobals[s]=i)}const t=new Float32Array(S.GLOBALS_WPAD_SIZE_BYTES/4);t.set(this.lastGlobals.resolution??[0,0],0),t.set(this.lastGlobals.camPos??[0,3,4],4),t.set(this.lastGlobals.camFwd??[0,0,-1],8),t.set(this.lastGlobals.camRight??[1,0,0],12),t.set(this.lastGlobals.camUp??[0,1,0],16),t.set([this.lastGlobals.time??0,this.lastGlobals.deltaTime??0,this.lastGlobals.objectCount??0],20),this.device.queue.writeBuffer(this.globalsBuffer,0,t)}}class k{position=g(1,3,3);target=g(0,0,0);up=g(0,1,0);forward=h();right=h();upVec=h();constructor(){this.updateMatrices()}updateMatrices(){E(this.forward,this.target,this.position),b(this.forward,this.forward),y(this.right,this.forward,this.up),b(this.right,this.right),y(this.upVec,this.right,this.forward),b(this.upVec,this.upVec)}orbit(e,t,s=.005){const i=h();E(i,this.position,this.target);let o=M(i);o<1e-4&&(o=1e-4);let r=Math.atan2(i[2],i[0]),a=Math.acos(i[1]/o);r+=e*s,a-=t*s;const c=.1;a=Math.max(c,Math.min(Math.PI-c,a)),i[0]=o*Math.sin(a)*Math.cos(r),i[1]=o*Math.cos(a),i[2]=o*Math.sin(a)*Math.sin(r),z(this.position,this.target,i)}pan(e,t,s=.01){const i=h();E(i,this.target,this.position),b(i,i);const o=h();y(o,i,this.up),b(o,o);const r=h();y(r,o,i),C(this.position,this.position,o,-e*s),C(this.target,this.target,o,-e*s),C(this.position,this.position,r,t*s),C(this.target,this.target,r,t*s)}zoom(e,t=.05,s=1,i=50){const o=h();E(o,this.position,this.target);let r=M(o);r<1e-4&&(r=1e-4),r+=e*t,r=Math.max(s,Math.min(i,r)),b(o,o),X(o,o,r),z(this.position,this.target,o)}}class P{_element;title="";constructor(e,t){this._element=e??document.createElement("div"),t&&(this.title=t)}loaded(){this.resize()}get element(){return this._element}}class H extends P{canvas;init(){this.canvas=this._element.querySelector("canvas"),this.resize()}resize(){const e=this._element.getBoundingClientRect();this.canvas.width=e.width,this.canvas.height=e.height}}class Z extends P{items=[];activeItem=null;init(){this._element.addEventListener("click",()=>{this.activeItem&&this.activateItem(null)});const e=document.createElement("div");e.textContent="Scene",this._element.prepend(e)}resize(){}addItem(e){const t=document.createElement("div");t.classList.add("scene-panel-item"),t.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation(),e.onClick(e),this.activateItem(e)});const s=document.createElement("div");s.textContent=e.text;const i=document.createElement("div");i.classList.add("buttons");const o=document.createElement("div");o.textContent="⎘",o.classList.add("copy-button"),o.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation(),e.onCopy(e)});const r=document.createElement("div");r.textContent="x",r.classList.add("del-button"),r.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation(),this.removeItem(e)}),i.append(o,r),t.append(s,i),this._element.appendChild(t),e.html=t,this.items.push(e)}removeItem(e){console.log(this.items);const t=this.items.findIndex(s=>s===e);t>=0&&(this.activeItem===e&&this.activateItem(null),e.onDelete(e),e.html.remove(),this.items.splice(t,1))}activateItem(e){this.activeItem&&(this.activeItem.html.classList.remove("activate"),this.activeItem.onLeave(this.activeItem)),this.activeItem=e,e&&(e.html.classList.add("activate"),e.onActivate(e))}}class V extends P{items=[];selectedItem=null;onSelect=null;init(){const e=document.createElement("div");e.textContent="Toolbox",this._element.prepend(e),this._element.classList.add("toolbox-panel"),this.render()}resize(){}setItems(e){this.items=e,this.render()}render(){const e=this._element.firstElementChild;this._element.innerHTML="",e&&this._element.appendChild(e);const t=document.createElement("div");t.className="toolbox-list",this.items.forEach(s=>{const i=document.createElement("div");i.classList.add("scene-panel-item","toolbox-card"),this.selectedItem===s&&i.classList.add("activate");const o=this.getIconForTool(s.id);o.className="toolbox-icon";const r=document.createElement("div");r.className="toolbox-label",r.textContent=s.label,i.append(o,r),i.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation(),this.selectedItem=s,this.onSelect?.(s),this.render()}),t.appendChild(i)}),this._element.appendChild(t)}getIconForTool(e){const t=document.createElement("img");switch(t.className="toolbox-icon",e){case l.SPHERE:t.src="icons/sphere.png";break;case l.CUBE:t.src="icons/cube.png";break;case l.TORUS:t.src="icons/torus.png";break;case l.CYLINDER:t.src="icons/cylinder.png";break;case l.CONE:t.src="icons/cone.png";break;case l.CAPSULE:t.src="icons/capsule.png";break}return t}}class J extends P{_target=null;onFieldChange=null;init(){const e=document.createElement("div");e.textContent="Properties",e.className="panel-titlebar",this._element.appendChild(e);const t=document.createElement("p");t.className="properties-empty",t.innerText="No object selected",t.style.color="gray",this._element.appendChild(t)}resize(){}setTarget(e){this._target=e,this.render()}render(){const e=this._element.firstElementChild;if(this._element.innerHTML="",e&&this._element.appendChild(e),!this._target){const t=document.createElement("p");t.className="properties-empty",t.textContent="No object selected",t.style.color="gray",this._element.appendChild(t);return}this._element.appendChild(this.createVec3Section("Position","position",this._target.position)),this._element.appendChild(this.createVec3Section("Rotation","rotation",this._target.rotation)),this._element.appendChild(this.createVec3Section("Scale","scale",this._target.scale)),this._element.appendChild(this.createColorSection("Color","color",this._target.color))}createVec3Section(e,t,s){const i=document.createElement("div");i.classList.add("scene-panel-item","prop-section");const o=document.createElement("div");o.className="prop-title",o.textContent=e,i.appendChild(o);const r=document.createElement("div");return r.className="prop-row",["X","Y","Z"].forEach((c,u)=>{const _=document.createElement("div");_.className="prop-input-wrapper";const w=document.createElement("label");w.textContent=c,w.className="prop-label";const v=document.createElement("input");v.type="number",v.step="0.1",v.value=s[u].toString(),v.className="prop-input",v.addEventListener("change",()=>{if(!this._target)return;const A=parseFloat(v.value);Number.isNaN(A)||(this._target[t][u]=A,this.onFieldChange?.(t,this._target))}),_.append(w,v),r.appendChild(_)}),i.appendChild(r),i}createColorSection(e,t,s){const i=document.createElement("div");i.classList.add("scene-panel-item","prop-section");const o=document.createElement("div");o.className="prop-title",o.textContent=e,i.appendChild(o);const r=document.createElement("div");r.className="prop-row";const a=document.createElement("div");a.className="prop-input-wrapper";const c=document.createElement("label");c.textContent="Color",c.className="prop-label";const u=document.createElement("input");return u.type="color",u.className="prop-color-input",u.value=this.vec3ToHex(s),u.addEventListener("input",()=>{if(!this._target)return;const _=this.hexToVec3(u.value);this._target.color[0]=_[0],this._target.color[1]=_[1],this._target.color[2]=_[2],this.onFieldChange?.(t,this._target)}),a.append(c,u),r.appendChild(a),i.appendChild(r),i}vec3ToHex(e){const t=Math.round(Math.min(Math.max(e[0],0),1)*255),s=Math.round(Math.min(Math.max(e[1],0),1)*255),i=Math.round(Math.min(Math.max(e[2],0),1)*255),o=r=>r.toString(16).padStart(2,"0");return`#${o(t)}${o(s)}${o(i)}`}hexToVec3(e){const t=e.replace("#",""),s=parseInt(t.slice(0,2),16)/255,i=parseInt(t.slice(2,4),16)/255,o=parseInt(t.slice(4,6),16)/255;return[s,i,o]}}async function $(n){if(!navigator.gpu)throw Error("WebGPU not supported.");const e=await navigator.gpu.requestAdapter();if(!e)throw Error("Couldn't request WebGPU adapter.");const t=await e.requestDevice(),s=n.getContext("webgpu");if(!s)throw Error("Couldn't request WebGPU context.");const i=navigator.gpu.getPreferredCanvasFormat();return s.configure({device:t,format:i,alphaMode:"premultiplied"}),{context:s,device:t,format:i}}const K=document.getElementById("scene"),j=new H(K);j.init();j.loaded();const Q=document.getElementById("scene-manager"),x=new Z(Q);x.init();x.loaded();const ee=document.getElementById("toolbox"),R=new V(ee);R.init();const te=document.getElementById("properties"),G=new J(te);G.init();const ne=[{id:l.SPHERE,label:"Sphere"},{id:l.CUBE,label:"Cube"},{id:l.TORUS,label:"Torus"},{id:l.CYLINDER,label:"Cylinder"},{id:l.CONE,label:"Cone"},{id:l.CAPSULE,label:"Capsule"}];function N(n){const e=n.data;m.selectObject(e),G.setTarget(e)}function ie(n){const e=n.data;U(e.copy())}function se(n){const e=n.data;m.removeObject(e)}function oe(){m.selectObject(null),G.setTarget(null)}function re(n,e,t){let s=-1;for(const i of t){const o=i.text;if(o.startsWith(n)){const r=o.slice(n.length),a=parseInt(r);isNaN(a)||(s=Math.max(s,a))}}return`${n}${s+1}`}R.setItems(ne);R.onSelect=n=>{const e=n.label.toLowerCase().replace(/\s+/g,""),t=re(e,n.id,x.items),s=new p({name:t,primitive:n.id,position:[0,.5,0],scale:[.5,.5,.5]});U(s)};G.onFieldChange=(n,e)=>{e.update?.()};const d=j.canvas,{device:ae,context:ce,format:le}=await $(d),m=new S({device:ae,context:ce,format:le}),f=new k;let O=!1,T=!1,I=[0,0];d.addEventListener("mousedown",n=>{const e=d.getBoundingClientRect();I=[n.clientX-e.left,n.clientY-e.top],n.button===0&&(O=!0),n.button===2&&(T=!0),n.button===2&&n.preventDefault()});d.addEventListener("mouseup",n=>{n.button===0&&(O=!1),n.button===2&&(T=!1)});d.addEventListener("mouseleave",()=>{O=!1,T=!1});d.addEventListener("contextmenu",n=>n.preventDefault());d.addEventListener("mousemove",n=>{const e=d.getBoundingClientRect(),t=n.clientX-e.left,s=n.clientY-e.top,i=t-I[0],o=s-I[1];I=[t,s];const r=.005,a=.01;O&&(f.orbit(i,o,r),f.updateMatrices()),T&&(f.pan(i,o,a),f.updateMatrices())});d.addEventListener("wheel",n=>{f.zoom(n.deltaY),f.updateMatrices()},{passive:!1});function Y(){j.resize(),m.updateGlobals({resolution:[d.width,d.height]})}Y();window.addEventListener("resize",Y);U(new p({name:"sphere0",primitive:l.SPHERE,position:[0,.5,0],scale:[.5,.5,.5]}),!1);function U(n,e=!0){m.addObject(n);const t={text:n.name,data:n,onClick:N,onCopy:ie,onActivate:N,onLeave:oe,onDelete:se};x.addItem(t),e&&x.activateItem(t)}let q=performance.now();function F(n){const e=n/1e3,t=(n-q)/1e3;q=n,m.updateGlobals({resolution:[d.width,d.height],camPos:f.position,camFwd:f.forward,camRight:f.right,camUp:f.upVec,time:e,deltaTime:t,objectCount:m.getObjectCount()}),m.render(),requestAnimationFrame(F)}requestAnimationFrame(F);
